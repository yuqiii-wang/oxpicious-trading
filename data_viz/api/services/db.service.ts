/**
 * Database service — single pg.Pool for the entire API process.
 *
 * This is the canonical DB access layer for the API. All services import the
 * pool, query helpers, and value formatters from here.
 *
...
function loadDbEnv(): void {
  ...
  // The .env file lives at <repo>/database/.env (two levels above services/)
