...
# --- Shared SSE list-endpoint symbols (also used by stream_sse_price) -------
...
# this exact order. (For the today-snapshot full field set, see
# download_sse_trend.STREAM_SELECT_FIELDS.)
