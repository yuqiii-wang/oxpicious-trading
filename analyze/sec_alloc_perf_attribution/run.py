...
Pipeline
  0. Force: TRUNCATE analysis.sec_alloc_perf_attribution.
     Incremental: detect missing dates (index_identity vs perf_attribution);
     early-return if up to date.
  ...
  3a. Build + insert Index subjects (indices with composition vs all indices,
      excl. self-pairs) via ``build_and_insert``.
