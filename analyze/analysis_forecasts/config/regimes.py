...
WEIGHT_K_MONTHS = 12        # fit window length (emitted months)
...
# forecast_identities bucket vocabulary minus opp_pair — industries
# carry no regime split).
WEIGHT_FAMILIES: tuple[str, ...] = (
    "mov_rsi", "mov_std", "px_vol_state", "margin_ratio_state",
