...
--    MIGRATED to stats.mov_ave_market_hypes (builds market): the build
--    moved out of the analyze.mov_ave_spread pipeline into the
--    standalone `python -m builds.market_hypes` (builds/market_hypes),
--    writing the stats schema. The DDL now lives in
--    database/sql/stats/16_mov_ave_market_hypes.sql; consumers were
--    repointed. This DROP removes the legacy analysis-schema table and
--    its analysis_identity registry row.
-- ----------------------------------------------------------------------------
