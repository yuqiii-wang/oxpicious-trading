...
--  stamps forecast_results' period 'next'/'5d'/'20d' onto every
...
--  forecast_id → 4 period rows: next/5d/20d/mixed), measured from the
...
CREATE TABLE IF NOT EXISTS analysis_forecasts.high_low_streaks (
    ...
    CONSTRAINT ck_high_low_streaks_regime
