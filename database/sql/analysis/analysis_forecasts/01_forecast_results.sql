...
--                       20d: 1.0, 60d: 1.0} — the 2026-09 std-mode
...
CREATE TABLE IF NOT EXISTS analysis_forecasts.forecast_results (
    ...
    -- the scalar-bar event engines write it (mov_rsi:
...
--  analyze.analysis_forecasts.config; the analysis_signals emit
...
--    ave_change / reverse_prob — the weight mean
...
SELECT a.forecast_id,
       ...
       NULL::date[], NULL::date[], NULL::date[], NULL::bigint[],
       NULL::numeric[],
       a.s_rev / a.w_stat,
       a.thr_mix
FROM agg a
...
SELECT public.ensure_check_constraint(
    ...
    $chk$period IN ('next', '5d', '20d', '60d', 'mixed')$chk$);
SELECT public.ensure_check_constraint(
    'analysis_forecasts.forecast_results',
...
-- domain, positive mean streak lengths.
SELECT public.ensure_check_constraint(
