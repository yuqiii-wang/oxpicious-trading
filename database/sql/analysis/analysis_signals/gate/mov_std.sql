-- ============================================================================
--  analysis_signals confirmation gate — family mov_std
--
...
--  config filter = (ma_window, k) slice (STD_SIGNAL_K)
--
...
WITH bp AS (
    ...
    SELECT i.stat_month, m.ma_window AS win, m.side, i.code, i.sec_type,
    ...
    WHERE i.sec_type = $1 AND i.bucket = 'mov_std'
      AND (m.ma_window, m.k::float8) IN ((60, 2.0), (60, 2.5), (60, 3.0), (20, 2.0), (20, 2.5), (20, 3.0))
