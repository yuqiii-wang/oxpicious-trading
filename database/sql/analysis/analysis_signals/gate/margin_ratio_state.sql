-- ============================================================================
--  analysis_signals confirmation gate — family margin_ratio_state
--
...
--  config filter = m.ratio_state IN ('vlow', 'low')  (MARGIN_RATIO_SIGNAL_STATES)
--
...
WITH bp AS (
    ...
    SELECT i.stat_month, m.ratio_state AS win, m.side, i.code, i.sec_type,
