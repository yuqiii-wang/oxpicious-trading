-- ============================================================================
--  analysis_signals confirmation gate — family mov_pairs_ema
--
...
--  config filter = m.pair_window slice (PAIRS_SIGNAL_WINDOWS)
--
...
WITH bp AS (
    ...
    SELECT i.stat_month, m.pair_window AS win, m.side, i.code, i.sec_type,
