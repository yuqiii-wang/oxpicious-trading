...
-- 2026-09 index hygiene: idx_live_identity_name duplicated the PK (name)
-- — dropped here so existing installations lose it; fresh installs never
-- create it.
DROP INDEX IF EXISTS live.idx_live_identity_name;
