...
(mean-reversion, momentum, etc.) lives here:
  ...
  • upsert.py    — strategy_identity + trade_decision upsert (find_seq_id,
                   upsert_strategy_seq, insert_strategy_seq,
                   assign_decision_no, insert_decisions)
...
in their own package (e.g. strategy.singleton_trading).
"""
