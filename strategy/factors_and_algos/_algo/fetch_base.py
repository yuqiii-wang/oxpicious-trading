...
identical across all algos: the per-sec_type basic_stats table name (source
of OHLC fill prices) and the DataFrame post-processing (date normalization +
...
from strategy._common.constants import SEC_TYPE_BASIC_STATS_TABLE  # noqa: F401
...
__all__ = ["basic_stats_table", "rows_to_df"]
